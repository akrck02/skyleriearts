...
export class Errors {
  static archive: { [key: number]: IError } = {
    200: {
      code: 200,
      message: "Success",
      friendly: "Success",
    ...
    401: {
      ...
      description:
        "The content is protected, contact the administrator to get access.",
    },
    404: {
      code: 404,
      message: "Not found",
    ...
    500: {
      ...
      description:
        "The server is experimenting an unexpected error, contact the administrator for more information.",
    },
  };
   ...
   */
  public static getByCode(code: number) {
    return Error[code];
  }
}
